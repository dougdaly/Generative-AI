...
A2A_PROTOCOL = Path.cwd().parent / "src" 
sys.path.insert(0, str(A2A_PROTOCOL.resolve()))
from a2a.core import AgentResult
...
def score_task3(res: AgentResult) -> dict:
    ...
    contract = tool_parse_story_contract(prompt_text=TASK3_CONTRACT) 
